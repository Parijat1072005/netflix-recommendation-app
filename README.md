...
│
├── cult-ml.ipynb ← Full Kaggle notebook
│
├── backend/
│   ├── server.js                     ← Express API server
│   ├── recommend_worker.py           ← Python inference worker
│   ├── package.json
│   ├── model_svd.pkl                 ← [Generated by Cell 8]
│   ├── model_als_factors.pkl         ← [Generated by Cell 8]
│   ├── movie_mapping.json            ← [Generated by Cell 8]
│   ├── user_mapping.json             ← [Generated by Cell 8]
│   ├── top10_precomputed.json        ← [Generated by Cell 8]
│   └── dataset_stats.json           ← [Generated by Cell 8]
│
├── frontend/
│   ├── src/
│   │   ├── App.jsx
│   │   └── components/
│   │       └── RecommendationHub.jsx
│   ├── package.json
│   └── tailwind.config.js
│
└── README.md
